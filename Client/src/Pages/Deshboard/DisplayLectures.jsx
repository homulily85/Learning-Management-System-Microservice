...
function Displaylectures () {
  ...
  return (
    <HomeLayout>
      <div
        className="flex flex-col gap-10 items-center justify-center min-h-[90vh] py-10 text-wihte mx-[5%]">
        ...
        {(lectures && lectures.length > 0) ?
          (<div
            ...
            <div
              className="space-y-5 md:w-[28rem] md:h-[35rem]  p-2 rounded-lg shadow-[0_0_10px_black]">
              <video
            ...
            <div
              className="md:w-[28rem]  md:h-[35rem] p-2 rounded-lg shadow-[0_0_10px_black] space-y-4 ">
              <div
              ...
              <ul className=" space-y-4 md:overflow-y-auto">
                ...
                {lectures &&
                  lectures.map((lecture, idx) => {
                    return (
                      <li className="space-y-2 flex justify-between"
                          key={lecture._id}>
                        ...
                        {role === 'ADMIN' && (
                          <button onClick={() => onLectureDelete(state?._id,
                            lecture?._id)} className="font-semibold text-2xl">
                            <MdAutoDelete/>
                          </button>
                        )}
                      </li>
